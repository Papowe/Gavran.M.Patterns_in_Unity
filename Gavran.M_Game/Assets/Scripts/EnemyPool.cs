    ...
    internal sealed class EnemyPool
    {
        ...
        public Enemy GetEnemy(string type)
        {
            ...
            switch (type)
            {
                case "Asteroid":
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(type), type, "Не предусмотрен");
        ...
        private Enemy GetAsteroid(HashSet<Enemy> enemies)
        {
            ...
            if (enemy == null)
            {
                ...
                {
                    var laster = Resources.Load<Asteroid>($"Enemy/{NameManager.GetRandomNameEnemies()}");
                    var instantiate = Object.Instantiate(laster);
